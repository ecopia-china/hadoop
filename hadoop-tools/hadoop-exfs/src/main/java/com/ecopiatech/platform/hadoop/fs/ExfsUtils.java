...
public final class ExfsUtils {

  private static final Logger LOG = LoggerFactory.getLogger(ExfsUtils.class);
  ...
  public static void setBucketOption(Configuration conf, String bucket,
    ...
    final String baseKey = genericKey.startsWith(FS_S3A_PREFIX) ?
        ...
        : genericKey;
    conf.set(FS_S3A_BUCKET_PREFIX + bucket + '.' + baseKey, value, "ExfsUtils");
  }
