...
public class ExfsInstrumentation implements Closeable, MetricsSource {
  private static final Logger LOG = LoggerFactory.getLogger(
      ExfsInstrumentation.class);

  private static final String METRICS_SOURCE_BASENAME = "ExfsMetrics";

  /**
   * {@value #METRICS_SYSTEM_NAME} The name of the exfs-specific metrics
   * system instance used for exfs metrics.
   */
  public static final String METRICS_SYSTEM_NAME = "exfs-file-system";

  /**
   * {@value #CONTEXT} Currently all exfs metrics are placed in a single
  ...
  public ExfsInstrumentation(URI name) {
   ...
   * @param name exfs:// URI for the associated FileSystem instance
   */
