...
public class ExfsStorageStatistics extends StorageStatistics
    implements Iterable<StorageStatistics.LongStatistic> {
  private static final Logger LOG =
      LoggerFactory.getLogger(ExfsStorageStatistics.class);

  private final Map<Statistic, AtomicLong> opsCount =
      new EnumMap<>(Statistic.class);

  public ExfsStorageStatistics(String name) {
    super(name);
  ...
  @Override
  public String getScheme() { return "exfs"; }

  @Override
  public Iterator<LongStatistic> getLongStatistics() { return new LongIterator(); }
